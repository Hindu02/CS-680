...
public class ComparatorTest {
    ...
    public void verifyPriceComparator() {
        Arrays.sort(cars, (car1, car2) -> (int)(car1.getPrice() - car2.getPrice()));
    ...
    public void verifyMileageComparator() {
        Arrays.sort(cars, (car1, car2) -> car1.getMileage() - car2.getMileage());
    ...
    public void verifyParetoComparator() {
        Arrays.sort(cars, (car1, car2) -> car1.getDominationCount() - car2.getDominationCount());
