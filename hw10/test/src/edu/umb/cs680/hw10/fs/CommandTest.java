...
public class CommandTest {
    ...
    public void verifyCounting() {
        ...
        assert (cmd.v.getDirNum() == 4 && cmd.v.getFileNum() == 5 && cmd.v.getLinkNum() == 1);
    }
    ...
    public void verifyFileSearch() {
        ...
        assertIterableEquals(expected, cmd.v.getFoundFiles());
    }
    ...
    public void verifyFileCrawling() {
        ...
        assertIterableEquals(expected, cmd.v.getFiles());
    }
